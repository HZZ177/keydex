...
class ChatAction(StrEnum):
    ...
    SUBAGENT_RUN_UPDATED = "subagent_run_updated"
    SUBAGENT_CONTROL_RESULT = "subagent_control_result"
    ERROR = "error"
    PONG = "pong"
    STATUS = "status"
...
class ChatInboundAction(StrEnum):
    ...
    SUBAGENT_LIST_RUNS = "subagent_list_runs"
    SUBAGENT_GET_RUN = "subagent_get_run"
