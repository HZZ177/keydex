...
class ChatProjection:
    EVENT_TYPE_TO_ACTION = {
        ...
        DomainEventType.A2UI_STREAM_STARTED: ChatAction.A2UI_STREAM_START,
        DomainEventType.A2UI_STREAM_CHUNK: ChatAction.A2UI_STREAM_CHUNK,
        DomainEventType.A2UI_STREAM_FINISHED: ChatAction.A2UI_STREAM_FINISH,
        DomainEventType.A2UI_CREATED: ChatAction.A2UI_CREATED,
        DomainEventType.A2UI_SUBMITTED: ChatAction.A2UI_SUBMIT_ACK,
        DomainEventType.A2UI_CANCELLED: ChatAction.A2UI_CANCEL_ACK,
        DomainEventType.A2UI_RESUME_DEFERRED: ChatAction.A2UI_RESUME,
        DomainEventType.A2UI_RESUME_STARTED: ChatAction.A2UI_RESUME,
        DomainEventType.A2UI_RESUME_SUCCEEDED: ChatAction.A2UI_RESUME,
        DomainEventType.A2UI_RESUME_FAILED: ChatAction.A2UI_RESUME,
        ...
        DomainEventType.TURN_WAITING_INPUT: ChatAction.WAITING_INPUT,
