...
export const MCP_ERROR_MESSAGES: Record<McpErrorCode, string> = {
  ...
  tool_disabled_by_policy: "MCP 工具已被全局策略停用。",
  tool_disabled_by_session: "MCP 工具已在当前会话停用。",
  approval_required: "MCP 工具调用需要审批。",
  approval_rejected: "MCP 工具调用已被拒绝。",
  policy_denied: "MCP 策略拒绝了本次请求。",
  ...
  resource_reserved: "MCP Resources 已预留，本期暂不开放读取。",
