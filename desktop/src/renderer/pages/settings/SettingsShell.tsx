...
const settingsItems = [
  { id: "general", label: "常规", path: "/settings/general", icon: Settings, iconName: "settings" },
  { id: "appearance", label: "外观", path: "/settings/appearance", icon: Palette, iconName: "palette" },
  { id: "providers", label: "供应商配置", path: "/settings/providers", icon: Landmark, iconName: "landmark" },
  { id: "modelDefaults", label: "模型配置", path: "/settings/model-defaults", icon: Bot, iconName: "bot" },
  { id: "extensions", label: "扩展功能", path: "/settings/extensions", icon: ShieldEllipsis, iconName: "shield-ellipsis" },
