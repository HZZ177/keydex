import { Check, Download, Laptop, LoaderCircle, Type } from "lucide-react";
...
} from "@/renderer/providers/FontProvider";
  ...
  return (
    <main className={styles.page} data-settings-page data-testid="appearance-settings-page">
      ...
      <section className={styles.section} data-settings-group aria-labelledby="display-settings-title">
        <h2 className={styles.groupTitle} data-settings-group-title id="display-settings-title">
          应用显示
        </h2>
