            ...
            { type: "skill", label: "/review", skill_name: "review", content: "Review changes" },
            {
              ...
              metadata: {
                ...
                snapshot: {
                  ...
                  comment: { bodyMarkdown: "Historical note", tags: [], properties: [] },
                  page: {
                    title: "History",
                    documentUrl: "https://example.test/history",
                    canonicalUrl: "https://example.test/history",
                    urlKey: "f".repeat(64),
                  ...
                  anchor: {
                    kind: "region",
                    display: { label: "History region" },
                    semantic: { stableAttributes: [] },
                    content: {},
                    structure: { locators: [], headingPath: [] },
                    geometry: { rects: [] },
                    machineTarget: {
                      type: "region",
                  ...
                  observation: {
                    ...
                    currentTarget: null,
                    changes: { kinds: [], materialKinds: [], material: false, signals: [] },
                  },
                  integrity: {
