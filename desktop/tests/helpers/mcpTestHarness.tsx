...
export function createMcpRuntimeMock(options: McpRuntimeMockOptions = {}): McpRuntimeMock {
  ...
  const mcp = {
    ...
    listPrompts: vi.fn(() => resolve<McpPromptListResponse>({ list: [], total: 0, limit: 500 })),
    updatePromptPolicy: vi.fn((_serverId: string, promptId: string) => resolve({
      id: promptId,
      server_id: detail.id,
    ...
    exportConfig: vi.fn(() => resolve({ format: "keydex.mcp.v1", servers: [], tool_policies: [], prompt_policies: [] })),
