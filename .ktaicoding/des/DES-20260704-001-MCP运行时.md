...
| 禁用 tool | live guard 立即阻断后续执行 | 不再进入 snapshot |
...
- Tool 行：开关、tool 名称、risk badge、approval mode、effective state、下一轮/立即生效提示。
...
| Tools tab | 搜索、过滤、开关、审批策略、schema 查看、批量操作、schema changed |
